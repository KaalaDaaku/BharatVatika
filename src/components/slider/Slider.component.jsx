  ...
  return (
    <div id="carouselExampleControls" className="carousel slide" data-bs-ride="carousel">
      <div className="carousel-inner">
        ...
        <div className="carousel-item">
          <img src="https://images.pexels.com/photos/18858725/pexels-photo-18858725/free-photo-of-beautiful-blooming-daffodil.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" className="d-block w-100 slider-img" alt="..." />
        </div>
      </div>
